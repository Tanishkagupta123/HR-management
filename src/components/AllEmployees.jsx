        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="text-slate-400 text-[10px] uppercase tracking-widest border-b border-slate-100">
              <th className="pb-4 font-black">Emp Code</th>
              ...
              <th className="pb-4 font-black">Position</th>
                ...
                >
                  ...
                  <td className="py-3">
                    {emp.profile_pic ? (
                      ...
                      <div className="w-10 h-10 rounded-full bg-violet-100 flex items-center justify-center text-sm font-bold text-violet-900">
                  ...
                  <td className="py-5 text-violet-700 font-semibold">
                    {emp.role_position || "Employee"}
                  </td>
